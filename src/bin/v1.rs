...
//!
//! It works but there are still issues with it
//!
//! Swith the comment at line 809:
//!
//! ```text
//! impl<'ro_me, 'ro_d, K> MapApiRO<'ro_d, K> for &'ro_me LevelMap
//! where
//!     K: MapKey,
//!     // &'ro_me Level: MapApiRO<'ro_me, K>,
//!     for<'him> &'him Level: MapApiRO<'him, K>,
//! ```
//!
//! It gets a compilation error:
//!
//! ```text
//! error[E0277]: the trait bound `String: Borrow<Q>` is not satisfied
//!    --> src/bin/map-api-lifetime.rs:826:23
//!     |
//! 826 |         self.to_ref().get(key)
//!     |                       ^^^ the trait `Borrow<Q>` is not implemented for `String`
//!     |
//! help: consider extending the `where` clause, but there might be an alternative better way to express this requirement
//!     |
//! 808 |     &'ro_me Level: MapApiRO<'ro_me, K>, String: Borrow<Q>
//!     |                                       ~~~~~~~~~~~~~~~~~~~
//! ```
